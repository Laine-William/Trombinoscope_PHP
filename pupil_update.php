...
if (isset($_POST['pupil_id']) & isset($_POST['pupil_first_name']) & isset($_POST['pupil_last_name']) & isset($_POST['pupil_age']) & isset($_FILES['pupil_image']) & isset($_POST['class_cat_id']) & isset($_POST['class_id']) & isset($_POST['user_id'])){
    ...
    try {
        ...
        $pupil_image = $_FILES['pupil_image']['name'];
        ...
        $sth = $db->prepare("UPDATE `pupils` SET `pupil_first_name`=:pupil_first_name, `pupil_last_name`=:pupil_last_name, `pupil_age`=:pupil_age, `pupil_image`=:pupil_image, `class_cat_id`=:class_cat_id, `class_id`=:class_id, `user_id`=:user WHERE `pupil_id`=:pupil_id");
        ...
        <div class="row col-xs-6 block2 bg--primary center">
            <div class="form-group" >
                ...
                <div class="col-sm-8 col-xs-12">
                    <input type="number" placeholder="Modifier le numero de l'eleve" name="pupil_id" required="true" class="form-control"></input></br>
                </div>
            </div> 
            ...
            <div class="form-group" >
                ...
                <div class="col-sm-8 col-xs-12">
                    <input type="text" placeholder="Modifier le prenom de l'eleve" name="pupil_first_name" required="true" class="form-control"></input></br>
                </div>
            </div> 
            ...
            <div class="form-group" >
                ...
                <div class="col-sm-8 col-xs-12">
                    <input type="number" placeholder="Modifier l'age" name="pupil_age" required="true" class="form-control"></input></br>
                </div>
            </div> 
            ...
            <div class="form-group" >
                ...
                <div class="col-sm-8 col-xs-12">
                    <input type="file" placeholder="Choisissez une nouvelle image" name="pupil_image" required="true" class="form-control"></input></br>
                </div>
            </div>
