...
/* Vérifie et insère les données de la table classe */
if (isset($_POST['class_name']) & isset($_POST['class_localisation']) & isset($_FILES['class_image']) & isset($_POST['class_year']) & isset($_POST['class_number_pupils']) & isset($_POST['class_cat_id']) & isset($_POST['user_id'])){
    ...
    try {
        ...
        $sth = $db->prepare("INSERT INTO `classes` (`class_name`, `class_localisation`, `class_image`, `class_year`, `class_number_pupils`, `class_cat_id`, `user_id`) VALUES (:class_name, :class_localisation, :class_image, :class_year, :class_number_pupils, :class_cat_id, :user)");
    ...
    <form action="" method ="POST" class="form-horizontal" enctype="multipart/form-data">
        <div class="row col-xs-6 block2 bg--primary center">
            ...
            <div class="form-group" >
                ...
                <div class="col-sm-8 col-xs-12">
                    <input type="text" placeholder="Entrer le nom de l'etablissement" name="class_name" required="true" class="form-control"></input></br>
                </div>
            </div> 
            ...
            <div class="form-group" >
                ...
                <div class="col-sm-8 col-xs-12">
                    <input type="text" placeholder="Entrer la localisation de l'etablissement" name="class_localisation" required="true" class="form-control"></input></br>
                </div>
            </div> 
            ...
            <div class="form-group" >
                ...
                <div class="col-sm-8 col-xs-12">
                    <input type="file" placeholder="Choissisez une image" name="class_image" required="true" class="form-control"></input></br>
                </div>
            </div> 
            ...
            <div class="form-group" >
                ...
                <div class="col-sm-8 col-xs-12">
                    <input type="number" placeholder="Entrer un nombre d'eleve" name="class_number_pupils" required="true" class="form-control"></input></br>
                </div>
            </div>
